local config = {
	[6087] = {storage = PlayerStorageKeys.OutfitQuest.HunterMusicSheet01, text = 'first'},
	[6088] = {storage = PlayerStorageKeys.OutfitQuest.HunterMusicSheet02, text = 'second'},
	[6089] = {storage = PlayerStorageKeys.OutfitQuest.HunterMusicSheet03, text = 'third'},
	[6090] = {storage = PlayerStorageKeys.OutfitQuest.HunterMusicSheet04, text = 'fourth'}
}
