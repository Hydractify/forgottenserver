...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		if player:getStorageValue(PlayerStorageKeys.postman.Mission01) < 1 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.postman.Mission01) == 5 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.postman.Mission02) == 2 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.postman.Mission03) == 2 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.postman.Rank) == 4 and player:getStorageValue(PlayerStorageKeys.postman.Mission09) == 0 then
			npcHandler:say("So are you ready for another mission?", cid)
			npcHandler.topic[cid] = 25
		elseif player:getStorageValue(PlayerStorageKeys.postman.Mission09) == 3 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.postman.Mission10) == 2 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Mission10, 3)
			npcHandler.topic[cid] = 0
		end
	elseif msgcontains(msg, "dress pattern") then
		if player:getStorageValue(PlayerStorageKeys.postman.Mission06) == 2 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Mission06, 3)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.postman.Mission06) == 4 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Mission06, 5)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(PlayerStorageKeys.postman.Mission06) == 6 then
		...
		elseif player:getStorageValue(PlayerStorageKeys.postman.Mission06) == 10 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Mission06, 11)
			npcHandler.topic[cid] = 0
		end
	...
	elseif msgcontains(msg, "advancement") then
		if player:getStorageValue(PlayerStorageKeys.postman.Mission04) == 2 and player:getStorageValue(PlayerStorageKeys.postman.Rank) == 1 then
			npcHandler:say("You are worthy indeed. Do you want to advance in our guild?", cid)
			npcHandler.topic[cid] = 14
		elseif player:getStorageValue(PlayerStorageKeys.postman.Mission06) == 13 and player:getStorageValue(PlayerStorageKeys.postman.Rank) == 2 then
			npcHandler:say("You are worthy indeed. Do you want to advance in our guild?", cid)
			npcHandler.topic[cid] = 20
		elseif player:getStorageValue(PlayerStorageKeys.postman.Mission08) == 3 and player:getStorageValue(PlayerStorageKeys.postman.Rank) == 3 then
			npcHandler:say("You are worthy indeed. Do you want to advance in our guild?", cid)
			npcHandler.topic[cid] = 24
		elseif player:getStorageValue(PlayerStorageKeys.postman.Mission10) == 3 and player:getStorageValue(PlayerStorageKeys.postman.Rank) == 4 then
			npcHandler:say("You are worthy indeed. Do you want to advance in our guild?", cid)
	...
	elseif msgcontains(msg, "yes") then
		...
		elseif npcHandler.topic[cid] == 7 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Mission01, 1)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 8 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Mission01, 6)
			player:setStorageValue(PlayerStorageKeys.postman.Mission02, 1)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 9 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Rank, 1)
		...
		elseif npcHandler.topic[cid] == 10 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Mission02, 3)
			player:setStorageValue(PlayerStorageKeys.postman.Mission03, 1)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 11 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Mission03, 3)
			player:setStorageValue(PlayerStorageKeys.postman.Mission04, 1)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 13 then
			if getPlayerBones(cid) >= 20 then
				...
				player:setStorageValue(PlayerStorageKeys.postman.Mission04, 2)
				npcHandler.topic[cid] = 0
			end
		elseif npcHandler.topic[cid] == 14 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Rank, 2)
		...
		elseif npcHandler.topic[cid] == 15 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Mission05, 1)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 16 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Mission05, 4)
			player:setStorageValue(PlayerStorageKeys.postman.Mission06, 1)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 18 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Mission06, 7)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 19 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Mission06, 13)
			player:setStorageValue(PlayerStorageKeys.postman.Mission07, 1)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 20 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Rank, 3)
			npcHandler.topic[cid] = 0
		...
		elseif npcHandler.topic[cid] == 22 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Mission07, 8)
			player:setStorageValue(PlayerStorageKeys.postman.Mission08, 1)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 23 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Mission08, 3)
			player:setStorageValue(PlayerStorageKeys.postman.Mission09, 0)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 24 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Rank, 4)
		...
		elseif npcHandler.topic[cid] == 25 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Mission09, 1)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 26 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Mission09, 4)
			player:setStorageValue(PlayerStorageKeys.postman.Mission10, 1)
		...
		elseif npcHandler.topic[cid] == 27 then
			...
			player:setStorageValue(PlayerStorageKeys.postman.Rank, 5)
			player:setStorageValue(PlayerStorageKeys.postman.Door, 1)
			npcHandler.topic[cid] = 0
		end
	end
	return true
