...
local function creatureSayCallback(cid, type, msg)
	...
	if isInArray({"addon", "outfit"}, msg) then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.DruidHatAddon) < 1 then
	...
	elseif msgcontains(msg, "faolan") then
		...
		elseif player:getStorageValue(PlayerStorageKeys.OutfitQuest.DruidHatAddon) == 8 then
			...
			player:setStorageValue(PlayerStorageKeys.OutfitQuest.DruidHatAddon, 9)
	...
	elseif msgcontains(msg, "task") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.DruidHatAddon) == 2 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.OutfitQuest.DruidHatAddon) == 4 then
			npcHandler:say({
		...
		elseif player:getStorageValue(PlayerStorageKeys.OutfitQuest.DruidHatAddon) == 6 then
			npcHandler:say({
	...
	elseif msgcontains(msg, "waterskin") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.DruidHatAddon) == 3 then
			npcHandler:say("Did you bring me a sample of water from the hydra cave?", cid)
			npcHandler.topic[cid] = 7
		end
	elseif msgcontains(msg, "dust") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.DruidHatAddon) == 5 then
	...
	elseif msgcontains(msg, "yes") then
		...
		elseif npcHandler.topic[cid] == 4 then
			...
			player:setStorageValue(PlayerStorageKeys.OutfitQuest.DruidHatAddon, 1)
		...
		elseif npcHandler.topic[cid] == 5 then
			if player:removeItem(5937, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.OutfitQuest.DruidHatAddon, 2)
				npcHandler.topic[cid] = 0
			end
		elseif npcHandler.topic[cid] == 6 then
			...
			player:setStorageValue(PlayerStorageKeys.OutfitQuest.DruidHatAddon, 3)
		...
		elseif npcHandler.topic[cid] == 7 then
			if player:removeItem(5939, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.OutfitQuest.DruidHatAddon, 4)
				npcHandler.topic[cid] = 0
			end
		elseif npcHandler.topic[cid] == 8 then
			npcHandler:say("Good! I will eagerly await your return.", cid)
			player:setStorageValue(PlayerStorageKeys.OutfitQuest.DruidHatAddon, 5)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 9 then
			if player:removeItem(6550, 100) then
				...
				player:setStorageValue(PlayerStorageKeys.OutfitQuest.DruidHatAddon, 6)
				npcHandler.topic[cid] = 0
			end
		elseif npcHandler.topic[cid] == 10 then
			...
			player:setStorageValue(PlayerStorageKeys.OutfitQuest.DruidHatAddon, 7)
			player:setStorageValue(PlayerStorageKeys.OutfitQuest.DruidAmuletDoor, 1)
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 11 then
			if player:removeItem(5940, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.OutfitQuest.DruidHatAddon, 8)
				npcHandler.topic[cid] = 0
			end
