...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "They are nasty monsters, particularly as they have distance fighters and mages in their clans. My {backpack} is handmade from minotaur leather."
	})
...
local prisonerKeyword = keywordHandler:addKeyword(
	{"prisoner"},
	StdModule.say,
	{
		npcHandler = npcHandler,
...
prisonerKeyword:addChildKeyword(
	{"yes"},
	StdModule.say,
	{
		npcHandler = npcHandler,
...
local salmonKeyword = keywordHandler:addKeyword(
	{"salmon"},
	StdModule.say,
	{
		npcHandler = npcHandler,
...
-- Logbook Quest
local bookKeyword = keywordHandler:addKeyword(
	{"book"},
	StdModule.say,
	{
		npcHandler = npcHandler,
