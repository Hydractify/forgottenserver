...
keywordHandler:addKeyword(
	...
	StdModule.say,
	{
		npcHandler = npcHandler, text = "I'm fine. I'm so glad to have you here as my customer."
	})
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "Bugs plague this isle, but my wares are bug-free, totally bug-free."
	})
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "Blueberries grow on bushes. They're quite common in Tibia. Just pick them from a bush if you need a snack!"
	})
...
-- Pick quest
local pickKeyword = keywordHandler:addKeyword(
	{"pick"},
	StdModule.say,
	{
		npcHandler = npcHandler,
		text = "Picks are hard to come by. I trade them only in exchange for high quality small axes. Would you like to make that deal?"
	})
