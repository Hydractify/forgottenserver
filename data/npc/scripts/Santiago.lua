...
local function greetCallback(cid)
	...
	if player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage) < 1 then
		player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage, 1)
		player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoQuestLog, 1)
		...
		storeTalkCid[cid] = 0
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage) == 1 then
		...
		storeTalkCid[cid] = 0
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage) == 2 then
		...
		return false
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage) == 3 then
		...
		storeTalkCid[cid] = 2
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage) == 4 then
		...
		storeTalkCid[cid] = 2
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage) == 5 then
		...
		return false
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage) == 6 then
		if player:removeItem(8710, 3) then
			...
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoQuestLog, 5)
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage, 7)
			storeTalkCid[cid] = 4
		else
			npcHandler:say("I've forgotten to tell you something. Of course I need proof that you killed cockroaches. Please bring me at least 3 of their legs. Good luck!", cid)
			return false
		end
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage) == 7 then
		...
		storeTalkCid[cid] = 4
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage) == 8 then
		...
		storeTalkCid[cid] = 5
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage) == 9 then
		...
		storeTalkCid[cid] = 6
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage) == 10 then
		...
		storeTalkCid[cid] = 7
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage) == 11 then
		npcHandler:setMessage(MESSAGE_GREET, "Welcome back! Where were we... ? Ah, right, I gave you a fish to eat?")
		storeTalkCid[cid] = 8
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage) == 12 then
		npcHandler:setMessage(MESSAGE_GREET, "Welcome back! Where were we... ? Ah, right, I asked you if you saw Zirella! Did you?")
		storeTalkCid[cid] = 9
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage) == 13 then
...
local function creatureSayCallback(cid, type, msg)
	...
	if isInArray({"yes", "right", "ok"}, msg) then
		...
		elseif storeTalkCid[cid] == 1 then
			...
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage, 2)
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoQuestLog, 2)
		...
		elseif storeTalkCid[cid] == 2 then
			if player:getItemCount(2651) > 0 then
				...
				if coatSlot then
					...
					player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage, 4)
					storeTalkCid[cid] = 3
				else
		...
		elseif storeTalkCid[cid] == 3 then
			...
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoQuestLog, 4)
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage, 5)
		...
		elseif storeTalkCid[cid] == 4 then
			...
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage, 8)
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoQuestLog, 6)
			storeTalkCid[cid] = 5
		elseif storeTalkCid[cid] == 5 then
			...
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage, 9)
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoQuestLog, 7)
			storeTalkCid[cid] = 6
		elseif storeTalkCid[cid] == 6 then
			...
			player:addHealth(-20)
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage, 10)
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoQuestLog, 8)
			player:sendTutorial(19)
			storeTalkCid[cid] = 7
		elseif storeTalkCid[cid] == 7 then
			...
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoQuestLog, 9)
			player:addItem(2667, 1)
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage, 11)
			storeTalkCid[cid] = 8
		elseif storeTalkCid[cid] == 8 then
			...
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage, 12)
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoQuestLog, 10)
			storeTalkCid[cid] = 9
		elseif storeTalkCid[cid] == 9 then
			...
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoNpcGreetStorage, 13)
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.SantiagoQuestLog, 11)
