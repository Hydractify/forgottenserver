...
local function greetCallback(cid)
	...
	if player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosNpcGreetStorage) < 1 then
		...
		player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosNpcGreetStorage, 1)
		player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosQuestLog, 1)
		storeTalkCid[cid] = 1
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosNpcGreetStorage) == 1 then
		...
		storeTalkCid[cid] = 1
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosNpcGreetStorage) == 2 then
		...
		storeTalkCid[cid] = 2
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosNpcGreetStorage) == 3 then
		...
		storeTalkCid[cid] = 3
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosNpcGreetStorage) == 4 then
		...
		storeTalkCid[cid] = 4
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosNpcGreetStorage) == 5 then
		...
		storeTalkCid[cid] = 5
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosNpcGreetStorage) == 6 then
	...
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosNpcGreetStorage) == 7 then
		...
		npcHandler:releaseFocus(cid)
		npcHandler:resetNpc(cid)
	elseif player:getStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosNpcGreetStorage) == 8 then
...
local function creatureSayCallback(cid, type, msg)
	...
	if isInArray({"yes", "help", "ok"}, msg) then
		if storeTalkCid[cid] == 1 then
			...
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosQuestLog, 2)
		...
		elseif storeTalkCid[cid] == 2 then
			...
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosNpcGreetStorage, 3)
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosQuestLog, 3)
			storeTalkCid[cid] = 3
		elseif storeTalkCid[cid] == 3 then
			...
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosNpcGreetStorage, 4)
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosQuestLog, 4)
			storeTalkCid[cid] = 4
		elseif storeTalkCid[cid] == 4 then
			...
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosNpcGreetStorage, 5)
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosQuestLog, 5)
			npcHandler:releaseFocus(cid)
			npcHandler:resetNpc(cid)
		elseif storeTalkCid[cid] == 5 then
			if player:getItemCount(2666) > 0 or player:getItemCount(2671) > 0 then
				...
				player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosQuestLog, 6)
				player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosNpcGreetStorage, 6)
				storeTalkCid[cid] = 6
			else
	...
	elseif msgcontains(msg, "trade") then
		if storeTalkCid[cid] == 6 then
			...
			player:setStorageValue(PlayerStorageKeys.RookgaardTutorialIsland.CarlosNpcGreetStorage, 7)
			storeTalkCid[cid] = 7
