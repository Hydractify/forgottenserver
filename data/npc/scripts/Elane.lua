...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "addon") or msgcontains(msg, "outfit") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.HunterHatAddon) < 1 then
	...
	elseif msgcontains(msg, "leather") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.HunterHatAddon) == 2 then
	...
	elseif msgcontains(msg, "chicken wing") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.HunterHatAddon) == 3 then
			npcHandler:say("Were you able to get hold of 5 enchanted chicken wings?", cid)
			npcHandler.topic[cid] = 6
		end
	elseif msgcontains(msg, "steel") then
		if player:getStorageValue(PlayerStorageKeys.OutfitQuest.HunterHatAddon) == 4 then
	...
	elseif msgcontains(msg, "yes") then
		...
		elseif npcHandler.topic[cid] == 3 then
			...
			player:setStorageValue(PlayerStorageKeys.OutfitQuest.HunterHatAddon, 1)
		...
		elseif npcHandler.topic[cid] == 4 then
			if player:removeItem(5947, 1) then
				...
				player:setStorageValue(PlayerStorageKeys.OutfitQuest.HunterHatAddon, 2)
				npcHandler.topic[cid] = 0
			else
		...
		elseif npcHandler.topic[cid] == 5 then
			if player:getItemCount(5876) >= 100 and player:getItemCount(5948) >= 100  then
				...
				player:setStorageValue(PlayerStorageKeys.OutfitQuest.HunterHatAddon, 3)
				npcHandler.topic[cid] = 0
			else
				npcHandler:say("You don't have it...", cid)
			end
		elseif npcHandler.topic[cid] == 6 then
			if player:removeItem(5891, 5) then
				...
				player:setStorageValue(PlayerStorageKeys.OutfitQuest.HunterHatAddon, 4)
				npcHandler.topic[cid] = 0
			else
				npcHandler:say("You don't have it...", cid)
			end
		elseif npcHandler.topic[cid] == 7 then
			if player:getItemCount(5887) >= 1 and player:getItemCount(5888) >= 1 and player:getItemCount(5889) >= 1  then
				...
				player:setStorageValue(PlayerStorageKeys.OutfitQuest.HunterHatAddon, 5)
